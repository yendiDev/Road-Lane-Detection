...
# read in image
image = cv2.imread('lane1_image.png')
...
canny_image = cv2.Canny(gray_image, threshold1=100, threshold2=250)
...
images = [cropped_image, image, image_lines]
titles = ['Cropped Image', 'Original', 'Image with Lines']
